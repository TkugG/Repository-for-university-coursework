 ...
 * คำอธิบาย: ส่วนท้ายเว็บไซต์ (Footer Component) และสคริปต์เสริม
 * ==========================================================
 */
?>
    </main>
    ...
    <footer class="bg-slate-900 text-slate-400 mt-16 border-t border-slate-800 no-print print:hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-xs">
                        ...
                        <li><a href="news.php" class="hover:text-white transition-colors">ข่าวสารประชาสัมพันธ์ (News & PR)</a></li>
                        <li><a href="organizer.php" class="hover:text-white transition-colors">สำหรับผู้จัดงาน (Organizer & PR)</a></li>
            ...
            <div class="border-t border-slate-800 mt-8 pt-6 text-center text-xs text-slate-500">
                <p>&copy; <?= date('Y') ?> IT วิ่งเข้าป่ามัน (RunLan Platform). พัฒนาด้วย PHP + MySQL</p>
            </div>
        </div>
    </footer>

    <!-- โหลด JavaScript ฝั่ง Client -->
